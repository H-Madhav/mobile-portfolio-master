...
var resizePizzas = function(size) {
  ...
  // We have deleted the function determineDx. It is not necessary to call it, since we will change the pizza size inside the changePizzaSizes
